...
\marginlabel{\bmenug{Config 2/3}\blink\bmenug{Planes}}
...
\begin{description}
\item[Registration] The registration of the aircraft.
\item[Comp. ID] The contest id of the aircraft.
...
\item[Empty Mass]  The weight of the rigged glider excluding the pilots or water ballast.
\item[Wing area]  Optional specification of the wing area of the glider type.
\item[Max.\ Cruise Speed] Optionally the maximum manoeuvring speed can
  be entered on this page to prevent the glide computer from commanding
  unrealistic cruise speeds during final glide or cruise mode.
