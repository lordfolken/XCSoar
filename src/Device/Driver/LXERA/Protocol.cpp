...
bool
LXEra::SendPacket(Port &port, Command command,
...
bool
LXEra::ReceivePacket(Port &port, Command command,
...
bool
LXEra::ReceivePacketRetry(Port &port, Command command,
                       void *data, size_t length, OperationEnvironment &env,
                       std::chrono::steady_clock::duration first_timeout,
                       std::chrono::steady_clock::duration subsequent_timeout,
                       std::chrono::steady_clock::duration total_timeout,
...
uint8_t
LXEra::calc_crc_char(uint8_t d, uint8_t crc)
{
  uint8_t tmp;
...
uint8_t
LXEra::calc_crc(const void *p0, size_t len, uint8_t crc)
{
...
bool
LXEra::ReadCRC(Port &port, void *buffer, size_t length, OperationEnvironment &env,
            std::chrono::steady_clock::duration first_timeout,
            std::chrono::steady_clock::duration subsequent_timeout,
            std::chrono::steady_clock::duration total_timeout)
{
