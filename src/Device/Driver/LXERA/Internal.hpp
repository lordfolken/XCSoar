...
#ifndef XCSOAR_DEVICE_DRIVER_LXERA_INTERNAL_HPP
#define XCSOAR_DEVICE_DRIVER_LXERA_INTERNAL_HPP
...
class LXEraDevice: public AbstractDevice
{
...
public:
  LXEraDevice(Port &_port, unsigned baud_rate)
    :port(_port),
     busy(false),
