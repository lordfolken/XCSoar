...
void HorizonRenderer::drawAircraftSymbol(Canvas &canvas,
                                         const PixelPoint &center, int radius,
...
void HorizonRenderer::rotate(PixelPoint point, PixelPoint center, Angle a,
                             PixelPoint &rotated) {
