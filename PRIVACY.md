...
You should always view the XCSoar application  with a questioning mind, and
feel free to raise any concerns you have about matters of privacy by contacting
us via [github issue tracker](https://github.com/XCSoar/issues).
...
Your data is saved on the device your run XCSoar on in the XCSoarData/logs
directory. The logs are not erased unless you do so.
